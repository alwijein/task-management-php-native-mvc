  ...
  <div class="row w-100 h-100">
    ...
    <div class=" d-flex col-lg-4 align-items-center p-5 bg-white">
      <div class="col-12 mx-auto">
        ...
        <form class="mt-2" action="/storeLogin" method="POST">
        <input type="hidden" name="type" value="login">
          <div class="mb-4">
            <label class="form-label" for="username">Username</label>
            <input class="form-control" id="username" type="text" name="username" aria-describedby="username" autofocus="" tabindex="1" />
          </div>
          <div class="mb-1">
            ...
            <div class="input-group input-group-merge form-userPwd-toggle">
              <input class="form-control form-control-merge" id="userPwd" type="password" name="userPwd" placeholder="············" aria-describedby="userPwd" tabindex="2" />
            </div>
          </div>
